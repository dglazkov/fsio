...
//
// The machinery is @fsio/ui's — it was this file and the terminal demo's,
...
export const { reporter, logText, log, step } = createReporter({
  page: "acp-demo",
  // What this page holds N of. `reporter.summary` is filled in by
  // conversations.ts (avoids an import cycle).
  summaryKey: "conversations",
  facts: () => ({ hasObserver }),
});

...
//
// Copied from `acp-demo/src/framing.ts`, which is where it was written and
// where its own tests still live. Copied rather than extracted because
// Pewter is built beside the three demos and duplication is accepted there
// (https://github.com/dglazkov/fsio/issues/164) — and because a library is
// extracted when two consumers have already written the same thing, not when
// one of them copies the other (PROCESS.md rule 6). If a third consumer
// appears, that is the signal.
//

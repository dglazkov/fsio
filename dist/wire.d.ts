...
export declare const isHello: (value: unknown) => value is Hello;
export declare const isConnect: (value: unknown) => value is Connect;
...
export declare function asCall(value: unknown): Call | null;
...
export declare const refusal: (id: number, error: ApiError) => Answer;
export declare const connect: (args?: unknown) => Connect;

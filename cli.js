...
`);
  write("extensions/agent/index.html", `<!doctype html>
<meta charset="utf-8" />
<title>Agent</title>
<link rel="stylesheet" href="./style.css" />
...
<script type="module" src="./main.ts"></script>
`);
  write("extensions/agent/style.css", `:root { color-scheme: light dark; }
html, body { height: 100%; }
body {
  margin: 0; display: flex; flex-direction: column;
  font: 15px/1.6 ui-monospace, SFMono-Regular, Menlo, monospace;
...
`);
  write("extensions/agent/main.ts", `// Where you talk to an agent \u2014 and this tab, not the host, is the ACP client.
//
